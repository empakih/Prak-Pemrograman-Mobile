package com.pemmob.mfqh.data.dummy
...
object DummyData {
    val categories = listOf(
        ...
        Category(id = 2, name = "Minuman", description = "Minuman Seger", products_count = 5),
    ...
    val products = listOf(
        ...
        Product(14, 3, categories[2], "Gantungan Kayu", "Gantungan kayu", 5000.0, 150, "dummy_product"),
